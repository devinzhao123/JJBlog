    ...
    <nav class="navbar navbar-inverse">
        ...
        <div id="navbar-menu" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li class="active"><a href="#">最新博文</a></li>
                <li><a href="#">最热博文</a></li>
                <li><a href="#">推荐博文</a></li>
                <li><a href="#">博客问答</a></li>
                <li><a href="#">我的博客</a></li>
        ...
        <form method="post" class="navbar-form navbar-right" role="search" style="margin-top: -35px;margin-right: 10px" id="indexSearchForm" action="${ctx}/index_list">
            <div class="form-group">
                <input type="text" id="keyword" name="keyword"  value="${keyword}" class="form-control" placeholder="Search">
            </div>
               ...
               <!-- rgba(60,63,65,0.31)-->
                ...
                <div class="foot-nav clearfix" style="position: absolute;left: 0px;margin-top: 40px;text-align: center">
                    <div class="foot-copyrights" style="margin-left: 200px">
                        ...
                        <p style="margin-top: 8px">&copy;www.dreamland.wang 吉吉网版权所有</p>
                    </div>
                </div>
            </div>
            <!--col-md-9结束 -->
...
<script language=javascript>
    ...
    function FormatDate(strTime) {
        ...
        var m = date.getMinutes();//获取当前的分钟数（0-59）
        if(m<10) m ='0'+m;
    ...
    function reply_up(id){
        ...
        if($("#change_color_"+id).is('.date-dz-z-click red')){
            num--;
            ...
            $("#change_color_"+id).find('.z-num').html(num);
            $("#change_color_"+id).find('date-dz-z-click').addClass('red');
        }
        $.ajax({
            type:'post',
            url:'/comment',

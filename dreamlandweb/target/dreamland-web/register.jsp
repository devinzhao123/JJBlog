...
<head>
	<meta charset="UTF-8">
	<title>注册页面</title>
	<meta name="keywords" content="吉吉博客">
	<meta name="content" content="吉吉博客">
    ...
    <div class="zhuce_kong" id="dre_div">
    	<div class="zc">
            ...
            <h3>欢迎注册</h3>
                ...
                <div>
               		<input id="protocol" type="checkbox" onclick="checkProtocol();"><span>已阅读并同意<a href="#" target="_blank" ><span class="lan">《吉吉网用户协议》</span></a></span>
                    <br/>
...
<script type="text/javascript">
    ...
    $("#to_register").click (function(){
        if(!checkProtocol()){
            $("#protocol_span").text("请勾选\"阅读并接受吉吉网用户协议\"！").css("color","red");
        }else{
            $("#protocol_span").text("");
        }
